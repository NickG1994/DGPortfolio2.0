    ...
    <div className={Skillstyle.SkillsContainer}>
      <div className={Skillstyle.left}>
        ...
        <p className={Skillstyle.paragraph}>
          ...
          elementum vulputate sed nunc. Nunc vel tellus sapien mauris sed massa
          a. Tortor egestas mi tortor phasellus. Feugiat quis ut porta maecenas
          a tincidunt donec ac platea. Enim pharetra arcu molestie purus
          interdum metus sodales in.
        </p>
        <br />
        <p className={Skillstyle.paragraph}>
          ...
          lacus bibendum elementum aliquet sit vestibulum praesent. Ac ultrices
          turpis scelerisque ut neque ut tellus sed. Risus vestibulum adipiscing
          gravida venenatis cras nunc egestas egestas netus.{" "}
        </p>
        <br />
        <p className={Skillstyle.paragraph}>
          Sem posuere id arcu rhoncus imperdiet. Non eu magna et ipsum hendrerit
          non sem semper. Quis consectetur at imperdiet ultricies id sed.
          Convallis proin in elit ante neque lorem purus aliquet est.Vitae
          viverra enim arcu etiam praesent feugiat etiam. Commodo ut nunc
          commodo sem. Viverra varius ornare arcu lacus facilisis amet.{" "}
        </p>
      </div>
